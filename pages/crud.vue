      ...
      <v-card>
        ...
        <v-card-text>
          <v-text-field
            variant="solo"
            label="Nama"
            v-model="data.datapemain.nama"
          ></v-text-field>
          <v-text-field
            variant="solo"
            label="Umur"
            v-model.number="data.datapemain.umur"
          ></v-text-field>
          <v-text-field
            variant="solo"
            label="Posisi"
            v-model="data.datapemain.posisi"
          ></v-text-field>
        </v-card-text>
        <v-card-actions>
...
function saveeditdialog() {
  ...
  data.datapemain = _.assign(
    {},
    (data.listpemain[data.onselectindex] = data.datapemain)
  );
}
